 ...
 */
public class BookSummaryView extends View {
    ...
    public BookSummaryView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = getContext().obtainStyledAttributes(
                attrs, R.styleable.BookSummaryView, defStyle, 0);

        mExampleString = a.getString(
                R.styleable.BookSummaryView_exampleString);
        mExampleColor = a.getColor(
                R.styleable.BookSummaryView_exampleColor,
                mExampleColor);
        // Use getDimensionPixelSize or getDimensionPixelOffset when dealing with
        // values that should fall on pixel boundaries.
        mExampleDimension = a.getDimension(
                R.styleable.BookSummaryView_exampleDimension,
                mExampleDimension);

        if (a.hasValue(R.styleable.BookSummaryView_exampleDrawable)) {
            mExampleDrawable = a.getDrawable(
                    R.styleable.BookSummaryView_exampleDrawable);
